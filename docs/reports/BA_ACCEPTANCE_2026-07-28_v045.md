...
> **Историческая версия (2026-07-29):** отчёт составлен по пилоту Thailand F&B / TikTok. Текущая продуктовая истина — **Китай / Douyin (抖音)**, см. `docs/DISCOVERY_AND_DOSSIER.md`. Даты и результаты ниже сохранены как есть для истории.
